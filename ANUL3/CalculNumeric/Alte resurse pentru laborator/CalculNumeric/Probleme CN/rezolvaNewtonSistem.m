function solutie = rezolvaNewtonSistem(f, fd, x0, eps)

NMAX = 100;
% rezolva aproximativ ecuatia f(x) = 0 cu precizia eps, 
% fd sunt derivatele lui f in raport cu fiecare variabila 
...
if ~succes 
    error('Nu am gasit solutia (e posibil ca ecuatia sa nu aiba solutie)');
