function ComparareSvsRF(n)
if~isequal (get(gcf,'tag'),'ComparareSvsRF')
    shg
    clf reset
   
    uicontrol('position',[300 5 25 22], 'string' ,'>','callback','ComparareSvsRF(''+1'')');
    set(gcf,'tag','ComparareSvsRF');
end
if nargin==0
    n=1;
elseif isequal(n,'+1')
